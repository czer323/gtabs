...
export const PROVIDERS: ProviderPreset[] = [
  {
    ...
    needsKey: false,
    isBuiltIn: true,
    helpText: "Free. Runs on-device in Chrome. Two flags to enable — click for setup guide.",
  },
  {
    id: "openrouter-free",
    ...
    helpText: "Free, no credit card. Sign up \u2192 copy key.",
    models: [
      "openrouter/free",
  ...
  },
  {
    ...
    helpText: "Free, no credit card. Fastest inference.",
    models: [
  ...
  },
  {
    ...
    helpText: "$25 free credit on signup + $150/mo via data sharing.",
    models: [
  ...
  },
  {
    ...
    helpText: "Paid. $5 free credit on signup.",
  ...
  },
  {
    ...
    helpText: "Paid. Usage-based pricing.",
  ...
  },
  {
    ...
    baseUrl: "https://openrouter.ai/api/v1",
    signupUrl: "https://openrouter.ai/keys",
    helpText: "Access 300+ models. Pay per token.",
    models: [
  ...
  },
  {
    ...
    helpText: "Run models locally. Install Ollama first.",
  },
];
